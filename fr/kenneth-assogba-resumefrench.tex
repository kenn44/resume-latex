...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  Thèse en Analyse Numérique et Calcul Scientifique & {\color{blue} Mobile} : 06 14 26 95 55 \\
...
\section{\color{blue}Education}
  \resumeSubHeadingListStart
    ...
    %Calcul Scientifique
      ...
      {\textbf{Sorbonne Université} (ex Université Pierre et Marie Curie) }{Sept. 2019 -- Present}
    \resumeSubheading
...
\section{\color{blue}Experience}
  \resumeSubHeadingListStart
      ...
      {Total R\&D}{Avril 2020 - Present}
      \resumeItemListStart
       \item{Développement d'un algorithme de génération de maillage hybride
      	\\\textbf{$\rhd$ \small{Étude de la littérature sur le maillage hybride
      	\\$\rhd$ Découverte des bases de la Géométrie algorithmique
      	\\$\rhd$ Utilisation de l'API de gmsh}}}
      \resumeItemListEnd
...
\resumeSubHeadingListStart
 \item{
  	\textbf{Programmation}{: Python, C++, Matlab, Freefem++, Code\_Aster, Git, \LaTeX}
  }
 \item{
...
\item{Étude du conditionnement et de l'influence du choix du solveur (MUMPS, GCPC, MULT\_FRONT) dans la résolution d'un problème de mécanique ou de thermique dans Salomé Méca.}
